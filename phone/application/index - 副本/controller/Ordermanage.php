...
class Ordermanage extends Base
{
	...
	public function order_customer_home(){
		...
		if(empty($param['start'])){
			   ...
			   $field='a.id,a.order_number,a.service_type_id,a.full_location,a.location_ext,a.amount_urgent,a.status,c.name as sname,a.step_type,b.real_name as bname,d.brand as d_brand,
   ...
   //师傅订单管理首页
	public function order_master_home(){
		...
		if(empty($param['start'])){
			   ...
			   $field='a.id,a.order_number,a.service_type_id,a.full_location,a.location_ext,a.amount_urgent,a.master_status,c.name as sname,a.work_step_number,a.work_step_service,b.username as bname,d.brand as d_brand,
