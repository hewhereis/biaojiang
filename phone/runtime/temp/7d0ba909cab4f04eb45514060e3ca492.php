<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\wamp64\www\phone/application/index\view\confrimreport\master_reports.html";i:1511400127;s:61:"D:\wamp64\www\phone/application/index\view\public\header.html";i:1511310882;s:59:"D:\wamp64\www\phone/application/index\view\public\menu.html";i:1510987403;s:61:"D:\wamp64\www\phone/application/index\view\public\footer.html";i:1510625091;}*/ ?>
<!DOCTYPE html>
<html>
     ...
     <div class="weui-flex__item">
      <div class="border1">
        <div class="tupian" id="uploaderInput">
          <img id="img_data" height="47" width="65" src="__PUBLIC__static/index/images/tj.png" onerror="this.src='__PUBLIC__static/index/images/tj.png'" alt="">
        </div>
     ...
     <div class="weui-flex__item">
      <div class="border1">
        <div class="tupian" id="uploaderInput1">
          <img id="img_data1" height="47" width="65" src="__PUBLIC__static/index/images/tj.png" onerror="this.src='__PUBLIC__static/index/images/tj.png'" alt="">
        </div>
     ...
     <div class="weui-flex__item">
      <div class="border1">
        <div class="tupian" id="uploaderInput2">
          <img id="img_data2" height="47" width="65" src="__PUBLIC__static/index/images/tj.png" onerror="this.src='__PUBLIC__static/index/images/tj.png'" alt="">
        </div>
        ...
        <div class="weui-flex__item">
          <div class="border1" :id="'uploaderInputq'+index">
            ...
            <input type="hidden" v-model="arr[index]">
               <img :src="'__DsQINiu__'+item.qian" height="47" width="65" :id="'arr'+index" onerror="this.src='__PUBLIC__static/index/images/tj.png'" alt="">
            </div>
            <p class="text6">维修前</p>
          </div>
         </div>
         <div class="weui-flex__item">
          <div class="border1" :id="'uploaderInputw'+index">
            ...
            <input type="hidden" v-model="arrs[index]">
              <img :src="'__DsQINiu__'+item.hou" height="47" width="65" :id="'arrs'+index" onerror="this.src='__PUBLIC__static/index/images/tj.png'"  alt="">
            </div>
            <p class="text6">维修后</p>
          </div>
         </div>
    ...
    <div class="box">
        ...
        <div class="weui-cells weui-cells_form tianjia">
            ...
            <!-- <div class="weui-cell" v-if="is_ok==1">
                <img :src="'__PUBLIC__public/'+img">
            </div>
            <div class="weui-cell" v-if="is_ok==1">
                <input type="text" placeholder="请填写服务确认码">
            </div> -->
        </div>
        <div class="btn" >
