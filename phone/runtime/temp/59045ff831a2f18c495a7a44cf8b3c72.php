<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\wamp64\www\phone/application/index\view\wallet\index15.html";i:1511507599;s:64:"D:\wamp64\www\phone/application/index\view\public\header_sy.html";i:1510987403;}*/ ?>
<!DOCTYPE html>
<html>
               ...
               fangshi:function(){
                ...
                if(this.radio1==1){
                        ...
                        success:function(data){
                            console.log(data);
                            if(data==true){
                                location.href="http://www.bj-wang.com/PhoneWxpay/project_cost?total="+_this.price+"&&uid="+_this.uid;
                            }else{
                                $.ajax({
