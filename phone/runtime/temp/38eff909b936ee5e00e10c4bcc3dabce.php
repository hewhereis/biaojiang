<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"D:\wamp64\www\phone/application/index\view\ordermanage\order_customer_home.html";i:1511767569;s:64:"D:\wamp64\www\phone/application/index\view\public\header_sy.html";i:1510987403;s:59:"D:\wamp64\www\phone/application/index\view\public\menu.html";i:1510987403;s:60:"D:\wamp64\www\phone/application/index\view\stype\repair.html";i:1511426867;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="tab-content">
						...
						<div class="text weui-flex">
							...
							<div class="right">
								...
								<span v-if="item.service_type_id==2" >﻿<div v-if="item.step_type==1">
			 <div v-if="item.status==1">	
				 <a :href="'__PUBLIC__select_master/'+item.order_number" class="bg-orange">去选标</a> 
			 </div>
			 <div v-if="item.status==2">	
				 <a :href="'__PUBLIC__settlement/'+item.order_number" class="bg-orange">去付款</a> 
			 </div>
			 <div v-if="item.status==3">	
				 <div v-if="item.step_number==8">	
					<a :href="'__PUBLIC__customer_nuclear/'+item.order_number" class="bg-orange">确认报告</a> 
				</div>
				
			 </div>
			 <div v-if="item.status==4">	
				 <a :href="'__PUBLIC__customer_reports/'+item.order_number" class="bg-orange">去验收</a> 
			 </div>
...
<div v-else-if="item.step_type==2">
		<div v-if="item.status==1">	
				<div v-if="item.step_number==2">	
					<a :href="'__PUBLIC__choose/'+item.order_number" class="bg-orange">挑主任师傅</a> 
				</div>
				 <div v-if="item.step_number==3">	
					<a :href="'__PUBLIC__consult1/'+item.order_number+'/wid/'+item.worker_id" class="bg-orange">咨询主任师傅</a> 
				</div>
				 <div v-if="item.step_number==4">	
					<a :href="'__PUBLIC__helper1/'+item.order_number+'/wid/'+item.worker_id" class="bg-orange">增加普通师傅</a> 
				</div>
		 </div>
		 <div v-if="item.status==2">	
			 <a :href="'__PUBLIC__settlement/'+item.order_number" class="bg-orange">去付款</a> 
						...
						<div class="right">
							...
							<div v-if="item.service_type_id==1 || item.service_type_id==2 || item.service_type_id==5">
								 <div v-if="item.status==1 || item.status==2 || item.status==3 || item.status==4">	
									 <a :href="'__PUBLIC__additional/'+item.order_number" style="w" class="bg-orange" style="width: 80px">追加项目</a> 
								 </div>
							</div>	
