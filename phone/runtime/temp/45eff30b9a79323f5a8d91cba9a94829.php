<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wamp64\www\phone/application/index\view\confrimreport\index.html";i:1511325738;s:61:"D:\wamp64\www\phone/application/index\view\public\header.html";i:1511310882;}*/ ?>
<!DOCTYPE html>
<html>
				...
				success:function(data){
						if(data.code==200){
								$.ajax({
									...
									url:"__PUBLIC__submit_reports2",
									success:function(data){
											if(data.code===200){
                                              alert(data.msg);
                                               window.location.href="__PUBLIC__customer_reports/"+'<?php echo $order_number; ?>';
											}else{
                                               alert(data.msg)
											}
									}
