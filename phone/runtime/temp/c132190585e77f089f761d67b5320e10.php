<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\wamp64\www\phone/application/index\view\personalcenter\customer_home.html";i:1511492866;s:66:"D:\wamp64\www\phone/application/index\view\public\headerblack.html";i:1510799168;s:59:"D:\wamp64\www\phone/application/index\view\public\menu.html";i:1510987403;s:61:"D:\wamp64\www\phone/application/index\view\public\footer.html";i:1511835802;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="ClientCenter">
        <div class="CenterTop">
            ...
            <div class="centerTopRight">
               ...
               <div class="userPhone">
                ...
                <div class="editInfo">
                    <a href="__PUBLIC__cus_information">
                        <span>资料</span>
        ...
        <div class="centerMenuList">
            <div class="centerMenuListInfo">
                <a href="__PUBLIC__wallet/index" class="centerMenuList-item">
            ...
            <div class="centerMenuListInfo">
                    <a href="__PUBLIC__apply/month" class="centerMenuList-item">
                        <div class='centerMenuList-item-Content'>
                            <div class="centerMenuList-item-photo">
                                <img src="__indexStatic__images/apply@2x.png" alt="" width='30' height='30'>
                            </div>
                            <div class="centerMenuList-item-info">
                                <div class="centerMenuList-item-info-left">
                                    <span>申请月结</span>
                ...
                <a href="__PUBLIC__wallet/index3" class="centerMenuList-item">
                    <div class='centerMenuList-item-Content'>
                        <div class="centerMenuList-item-photo">
                            <img src="__indexStatic__images/address@2x.png" alt="" width='30' height='30'>
                        </div>
                        <div class="centerMenuList-item-info">
                            <div class="centerMenuList-item-info-left">
                                <span>索取发票</span>
                    ...
                    <a href="__PUBLIC__address_admin" class="centerMenuList-item">
                            <div class='centerMenuList-item-Content'>
                                <div class="centerMenuList-item-photo">
                                    <img src="__indexStatic__images/address@2x.png" alt="" width='30' height='30'>
                                </div>
