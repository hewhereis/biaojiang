<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\web-php-5.6\bjtp5/application/index\view\allmessages\index.html";i:1510103679;s:62:"E:\web-php-5.6\bjtp5/application/index\view\public\header.html";i:1510103679;s:62:"E:\web-php-5.6\bjtp5/application/index\view\public\footer.html";i:1510103679;}*/ ?>
<!--nav-->
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="main master_message_page">

    <!-- 面包屑导航-->
    <div class="container container-hidden">
        <h5 class="page-header bx">
            <span>当前位置：</span>
            <small>消息&nbsp</small><span>>></span>
        </h5>
        <!-- 左边框-->
        <div class="row mt-10 " id="navigatesLeft">

            <div class="clo-xs-12 " id='navigatesRigth'>
                <div class=" panel-default height ">
                    <div class="panel-heading bg-orange">
                        <span>消息中心</span>
                    </div>
                </div>
                <div class="panel-body  pl-20 pr-20">
                    <a href="__PUBLIC__messages/system_messages" class="border-aspx ehe">

                        <img src="__PUBLIC__static/index/images/s_xitong.png" style="width: 40px;" class=" " alt=""/>
                        <b class="ml-10">系统消息</b>
                        <span class="ehe_s"><?php echo $system; ?></span>
                    </a>
                    <a href="__PUBLIC__messages/order_messages" class="border-aspx ehe">
                        <img src="__PUBLIC__static/index/images/d_dingdan.png" style="width: 40px;" class=" " alt=""/>
                        <b class="ml-10">订单消息</b>
                        <span class="ehe_s"><?php echo $order; ?></span>
                    </a>
                </div>
            </div>
        </div>
