<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"E:\web-php-5.6\bjtp5/application/admin\view\user\index.html";i:1509089411;s:62:"E:\web-php-5.6\bjtp5/application/admin\view\public\header.html";i:1505545259;s:62:"E:\web-php-5.6\bjtp5/application/admin\view\public\footer.html";i:1505545259;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>{{d[i].username}}</td>
                                <td>
                                    <img src="__DsQINiu__{{d[i].portrait}}" class="img-circle" style="width:35px;height:35px" onerror="this.src='__PUBLIC__static/admin/images/head_default.gif'"/>
                                </td>
                                <td>{{d[i].title}}</td>                                  
                                <td>{{d[i].loginnum}}</td>
