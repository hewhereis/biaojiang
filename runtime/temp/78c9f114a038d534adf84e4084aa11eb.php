<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"E:\web-php-5.6\bjtp5/application/admin\view\article\index.html";i:1509089411;s:62:"E:\web-php-5.6\bjtp5/application/admin\view\public\header.html";i:1505545259;s:62:"E:\web-php-5.6\bjtp5/application/admin\view\public\footer.html";i:1505545259;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <script id="list-template" type="text/html">
                            {{# for(var i=0;i<d.length;i++){  }}
                                <tr class="long-td">
                                    ...
                                    <td>{{d[i].title}}</td>
                                    <td>{{d[i].name}}</td>                                 
                                    <td><img src="__DsQINiu__{{d[i].photo}}" style="height: 30px" onerror="this.src=''__PUBLIC__static/admin/images/no_img.jpg'"/></td>
                                    <td>{{d[i].views}}</td>
