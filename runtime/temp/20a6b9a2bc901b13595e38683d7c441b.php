<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"E:\masterarea.com\biaojiang.local\public/../application/index\view\bjclientorder\index.html";i:1542902331;s:85:"E:\masterarea.com\biaojiang.local\public/../application/index\view\public\header.html";i:1542902331;s:85:"E:\masterarea.com\biaojiang.local\public/../application/index\view\public\footer.html";i:1542902331;}*/ ?>
<!--下单流程-->
<!DOCTYPE html>
<html lang="zh-CN">
    ...
    <div class="row">
        <div class="col-xs-12 text-center" >
            <div class="po">
                ...
                <img src="__PUBLIC__static/index/images/bjclie_1.png" alt="">
                <ul class="ukl">
                    <li>
                    </li>
                    <li>
            ...
            <div class="">
                <ul class="uk">
                    <li class="show">
                        <img src="__PUBLIC__static/index/images/a_1.jpg" class="img-responsive " style="width: 60%;margin: 0 auto" alt="">
                    </li>
                </ul>
            </div>
        </div>
...
<script>
    $(".ukl>li").click(function () {
        var limg=$(".uk>li").find('img').attr('src');
        var m=limg.split("a_")[1].split(".")[0];
        m=$(this).index()+1;
        m="_"+m+".";
       var src=limg.split("_")[0].concat(m).concat(limg.split("a_")[1].split(".")[1]);
        $(".uk>li").find('img').attr('src',src);
       var uimg=$(this).parent().siblings("img").attr("src").split(".")[0].split("_")[1];
        uimg=$(this).index()+1;
        uimg="__PUBLIC__static/index/images/bjclie_"+uimg+".png";
        $(this).parent().siblings("img").attr("src",uimg)
    });
</script>
<style>
	@font-face {
