<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\web-php-5.6\bjtp5/application/admin\view\brand\index.html";i:1516257561;s:62:"E:\web-php-5.6\bjtp5/application/admin\view\public\header.html";i:1505545259;s:62:"E:\web-php-5.6\bjtp5/application/admin\view\public\footer.html";i:1505545259;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="col-sm-12">
                    <div  class="col-sm-2" style="width: 100px">
                        <div class="input-group" >
                            <a href="<?php echo url('brandAdd'); ?>"><button class="btn btn-outline btn-primary" type="button">添加品牌</button></a>
                        </div>
                    </div>
                    ...
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('index'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="key" class="form-control" name="key" value="<?php echo $val; ?>" placeholder="输入需查询的品牌" />
                    ...
                    <table class="table table-bordered table-hover"  style="table-layout: fixed;">
                        ...
                        <script id="list-template" type="text/html">
                            ...
                            <tr class="long-td">
                                ...
                                <td>
                                    <a href="javascript:;" onclick="categoryEdit({{d[i].id}})" class="btn btn-primary btn-xs btn-outline">
...
<script type="text/javascript">
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("Brand/index"); ?>', {page: curr || 1,key:key}, function(data){
    ...
    function categoryEdit(id){
        location.href = './brandEdit/id/'+id+'.html';
    }

    //删除
    function del_ser(id){
        lunhui.confirm(id,'<?php echo url("del_ser"); ?>');
    }
