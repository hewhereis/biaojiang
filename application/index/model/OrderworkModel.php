...
class OrderworkModel extends Model
{
	...
	public function  getOrderWhere($map, $Nowpage, $limits,$uid){
			...
			$join = [
				['bj_users','bj_users.id = bj_orders.owner_id','LEFT'],
			...
			$field='bj_orders.*,bj_users.real_name as uname,bj_service.name as sname,bj_orders_maintain.brand as m_brand,bj_orders_maintain.photo_store as m_img,bj_orders_survey.brand as sur_brand,bj_orders_survey.photo as sur_img,bj_replace.brand as d_brand,bj_replace.photo_store as gjm_img,bj_orders_install.storefront as install_img,bj_orders_install.brand as i_brand,bj_orders_coaming.imgstore as coam_img,bj_orders_coaming.brand as coam_brand';
	...
	public function  getOrderWhere5($map, $Nowpage, $limits,$uid){
			...
			$where['bj_orders.worker_id']=$uid;
			$where['bj_orders.work_del']=0;
			$where['bj_orders.master_status']=6;
			$join = [
				['bj_users','bj_users.id = bj_orders.owner_id','LEFT'],
				['bj_service','bj_service.id = bj_orders.service_type_id','LEFT'],
				['bj_orders_maintain','bj_orders_maintain.order_number = bj_orders.order_number','LEFT'],
